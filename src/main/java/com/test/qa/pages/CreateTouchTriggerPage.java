...
public class CreateTouchTriggerPage extends BaseTest {
	...
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-navigation[1]/mat-sidenav-container[1]/mat-sidenav-content[1]/div[1]/app-triggers[1]/app-trigger-creator[1]/app-trigger-creator-form[1]/form[1]/div[1]/div[1]/mat-tab-group[1]/div[1]/mat-tab-body[1]/div[1]/div[1]/app-delivery-preset-options[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/app-content-group-details[1]/div[1]/app-expandable-panel[1]/mat-toolbar[1]/div[1]/div[1]/div[3]/mat-icon[1]")
	...
	@FindBy(xpath="//div[@class='common-title-container']//button[@type='submit']")
	...
	@FindBy(xpath="/html[1]/body[1]/app-root[1]/app-navigation[1]/mat-sidenav-container[1]/mat-sidenav-content[1]/div[1]/app-triggers[1]/app-trigger-creator[1]/app-trigger-creator-form[1]/form[1]/div[1]/div[2]/div[1]/div[1]/button[1]")
	WebElement create_trigger;
	WebDriver driver;

	public CreateTouchTriggerPage(WebDriver driver) throws IOException {
		this.driver=driver;
	...
	public Create_StoryCardsPage create_trigger() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		FileInputStream fs=new FileInputStream(prop.getProperty("CreateTouchTrigger"));
	    Workbook w= WorkbookFactory.create(fs);
	    Sheet sh=w.getSheet("CreateTouchTrigger");
	            ...
	            if (row != null) {
	        		...
	        		Cell cell = row.getCell(0);
	        		  ...
	        		  if (cell != null) {
                          ...
                          if(type1.equalsIgnoreCase("Touch"))
                          {
		...
		for(int i=1;i<=sh1.getLastRowNum();i++)
		{
				Row row1=sh1.getRow(i);
				 ...
				 if (row1 != null) {
		            ...
		            //Add Target
	    		    String before_xpath="//*[@class='mat-tab-group mat-primary ng-star-inserted']/div[1]/mat-tab-body[1]/div[1]/div[1]/app-delivery-preset-options[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/app-content-group-details[";
	               ...
	               driver.findElement(By.xpath(before_xpath+i+after_xpath)).click();
		            ...
		            String before_xpath1="//*[@class='mat-tab-group mat-primary ng-star-inserted']/div[1]/mat-tab-body[1]/div[1]/div[1]/app-delivery-preset-options[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/app-content-group-details[";
		            ...
		            Thread.sleep(2000);
		            TestUtil.javascript_button_click(driver, Confirm_Target);
			  		   ...
			  		   for(int j=1;j<=sh2.getLastRowNum();j++)
			  	    	{
			                  ...
			                  // String xpathAfter="-1']";
			                   ...
			                   WebElement create=driver.findElement(By.xpath("//div[@class='mat-tab-label mat-ripple ng-star-inserted']"));
